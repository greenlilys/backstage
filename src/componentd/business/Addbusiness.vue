					...
					<template v-for="items in battery">									
									...
									<div class="inputboxs flex-wrap flex-vertical flex-align-center">	
										<el-form-item label="换电费（元）：" label-width="120px">
											<div>
												<input class="oinput" v-model="items.powerratesd" placeholder="" type="text" />											
										...
										<el-form-item label="月租（元）：" label-width="120px">
											<div>
												<input class="oinput" v-model="items.monthrentsd" placeholder="" type="text" />											
										...
										<el-form-item label="季租（元）：" label-width="120px">
											<div>
												<input class="oinput" v-model="items.quarterrentsd" placeholder="" type="text" />											
										...
										<el-form-item label="年租（元）：" label-width="120px">
											<div>
												<input class="oinput" v-model="items.annualrentsd" placeholder="" type="text" />											
		...
		methods: {
			...
			submitForm(){//保存
				...
				for(let i = 0,len = battery.length;i<len;i++){//获得电池列表表格数据
					...
					obj.powerrate = battery[i].powerratesd || '';
					obj.monthrent = battery[i].monthrentsd || '';
					obj.quarterrent = battery[i].quarterrentsd || '';
					obj.annualrent = battery[i].annualrentsd || '';
