<template>
	<div class="flex-wrap flex-vertical">
		...
		<el-row type="flex" align="middle" class="p-10 mt-10 bw pb-0">
			<el-col :span="6">
			...
			<el-col>
				...
				<template>
					<div class="block page">
						<el-pagination @current-change="handleCurrentChange" :current-page.sync="currentPage" :pager-count="11" :page-size="10" layout="total, prev, pager, next" :total="totalCount">
						</el-pagination>
					</div>
				</template>
			</el-col>
