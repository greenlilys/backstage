		...
		<div class="hf flex-wrap flex-vertical">
			...
			<div class="paddinglist boxborder mt-10 flex-con bw pr">
				<el-table :data="tableData" style="width: 100%;">
					...
					<el-table-column prop="nickname" label="姓名" width="" align="left">
					</el-table-column>
					<el-table-column prop="phone" label="手机" width="" align="left">
					</el-table-column>
					<el-table-column prop="job" label="职务" width="" align="left">
					</el-table-column>
					<el-table-column prop="name" label="权限" width="" align="left">
					</el-table-column>
					<el-table-column prop="action" label="管理" width="" align="left">
...
<script>
	...
	export default {
		...
		methods: {
			...
			confirmIsuse() {//确认禁用员工账号
				var status = this.currentStatus == 0 ? 1 : 0;
				var id = this.currentId;
				this.$post('userAdmin/updateState', {
					id: id,
					status: status
				}).then(data => {
