...
<style scope>
	...
	.aside ul {	height: 880px;}
	
	.aside li {text-align: center;height: 50px;line-height: 50px;}
	.box li{border-bottom:1px solid #40A74D;color:#fff;	cursor: pointer;}
	
	.box li:nth-child(1){border-top:1px solid #40A74D;}
	.mainContent{flex:1;}
</style>