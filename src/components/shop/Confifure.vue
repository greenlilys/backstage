	...
	<div>					
							<template>
								<el-table :data="tableData" style="width: 100%;">
									...
									<el-table-column prop="types" label="记录类型" width="200" align="center">
									</el-table-column>
									<el-table-column prop="pickno" label="关联配货订单" align="center">
									</el-table-column>
									<el-table-column prop="Inventorydistribution" label="配货内容" width="110" align="center">
									</el-table-column>
									<el-table-column prop="pickprices" label="结算单价" width="90"  align="center">
									</el-table-column>
									<el-table-column prop="picktotal" label="总计金额" align="center">
									</el-table-column>
									<el-table-column prop="costdistribute" label="配货成本余额" align="center">
									</el-table-column>
	        ...
	        //console.log(`当前页: ${val}`);
		      ...
		      this.$get('shopLog/pickList',{
	    		...
	    		for(var i = 0,len=arr.length;i<len;i++){
						...
						for(var j = 0,lens=battery.length;j<lens;j++){
							arr[i].pickprices += '\n';
							arr[i].pickprices+=battery[j].pickprice+" 元"
						}
						if(arr[i].type==0){
							arr[i].types="加盟配货";
