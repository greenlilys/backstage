...
<script>
	export default {
		...
		methods: {
			...
			getoperAdmin({id=this.id,nickName=this.find,pageNo=1,provincename=this.provincename,cityname=this.cityname,countyname=this.countyname}={}){
